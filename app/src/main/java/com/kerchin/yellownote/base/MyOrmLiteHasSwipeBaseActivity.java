 ...
 */
public abstract class MyOrmLiteHasSwipeBaseActivity<H extends OrmLiteSqliteOpenHelper> extends BaseHasSwipeActivity {
    private volatile H helper;
    private volatile boolean created = false;
    private volatile boolean destroyed = false;
    private static Logger logger = LoggerFactory.getLogger(MyOrmLiteHasSwipeBaseActivity.class);

    public MyOrmLiteHasSwipeBaseActivity() {
    }
