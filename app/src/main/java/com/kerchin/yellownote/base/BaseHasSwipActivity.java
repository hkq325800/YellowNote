 ...
 */
public abstract class BaseHasSwipActivity extends BaseSwipeBackActivity /*implements SlidingPaneLayout.PanelSlideListener*/ {

    //    public boolean isExisTitle = true;
    //是否支持滑动返回
//    public boolean isSupportSwipeBack = true;
    public final static String TAG = BaseHasSwipActivity.class.getCanonicalName();
